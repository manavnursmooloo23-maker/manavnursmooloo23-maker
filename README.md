...
I’m a Business Analytics student at La Trobe University in Melbourne with a strong quantitative background in mathematics, economics, and data analysis.

I focus on using data to solve real-world business problems — combining technical skills with business understanding to deliver clear, actionable insights.
...
* 🎓 La Trobe University International Scholarship (50%) – awarded for academic excellence
* 📊 High Distinction WAM (82.7%)
* 🥇 Best Capstone Project (BUS3003)
* 📈 A-Level Results: 3 A* in Mathematics, Economics, and Accounting
* 🏅 Ranked 34th (Economics – Boys), 248th Nationally
...
* Turning data into practical business insights
* Clear and effective data visualisation
* Understanding the full data pipeline (data → analysis → decision)
* Building solutions that are both technically sound and useful in real contexts

---

## 📫 Contact

* LinkedIn: https://linkedin.com/in/manav-nursmooloo-627020285
* Email: [manavnursmooloo23@gmail.com](mailto:manavnursmooloo23@gmail.com)
